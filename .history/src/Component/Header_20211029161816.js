...
import { setUser, deleteUser,setItem,setTopping,getCartItem,deleteCartItem, orderdItem} from '../actions'
...
function Header(){
  ...
  //トッピングを持ってくる
  const getTopping = () => {
    firebase.firestore().collection('Items').doc('toppings').get().then(doc => {
